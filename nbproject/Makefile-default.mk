...
SOURCEFILES_QUOTED_IF_SPACED=DAACED.c DAACEDbitmap.c rtc.c lcd.c ui.c uart.c adc.c menu.c charger.c bluetooth.c PatuaOne_16pts.c PatuaOne_22pts.c PatuaOne_62pt.c eeprom.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/DAACED.p1 ${OBJECTDIR}/DAACEDbitmap.p1 ${OBJECTDIR}/rtc.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/ui.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/charger.p1 ${OBJECTDIR}/bluetooth.p1 ${OBJECTDIR}/PatuaOne_16pts.p1 ${OBJECTDIR}/PatuaOne_22pts.p1 ${OBJECTDIR}/PatuaOne_62pt.p1 ${OBJECTDIR}/eeprom.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/DAACED.p1.d ${OBJECTDIR}/DAACEDbitmap.p1.d ${OBJECTDIR}/rtc.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/ui.p1.d ${OBJECTDIR}/uart.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/menu.p1.d ${OBJECTDIR}/charger.p1.d ${OBJECTDIR}/bluetooth.p1.d ${OBJECTDIR}/PatuaOne_16pts.p1.d ${OBJECTDIR}/PatuaOne_22pts.p1.d ${OBJECTDIR}/PatuaOne_62pt.p1.d ${OBJECTDIR}/eeprom.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/DAACED.p1 ${OBJECTDIR}/DAACEDbitmap.p1 ${OBJECTDIR}/rtc.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/ui.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/charger.p1 ${OBJECTDIR}/bluetooth.p1 ${OBJECTDIR}/PatuaOne_16pts.p1 ${OBJECTDIR}/PatuaOne_22pts.p1 ${OBJECTDIR}/PatuaOne_62pt.p1 ${OBJECTDIR}/eeprom.p1

# Source Files
SOURCEFILES=DAACED.c DAACEDbitmap.c rtc.c lcd.c ui.c uart.c adc.c menu.c charger.c bluetooth.c PatuaOne_16pts.c PatuaOne_22pts.c PatuaOne_62pt.c eeprom.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/DAACED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/DAACED.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=icd3  --double=24 --float=24 --emi=wordwrite --opt=-asm,+asmfile,-speed,+space,-debug,+local --addrqual=ignore --mode=pro -P -N255 -V --warn=-5 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --errata=+NVMREG --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/DAACED.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
