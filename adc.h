...
#define ADC_ENABLE_INTERRUPT_SHOT_DETECTION              {ADPCH = shot_detection_source;ADCON3bits.ADSOI = 1;ADCON0bits.ADGO = 1; PIE1bits.ADTIE= 1;}
...
#define ADC_HW_detect_fall_init()   { ADCON3bits.ADTMD = 0b110; /* ADERR > ADUTH */ }
#define ADC_HW_detect_raise_init()  { ADCON3bits.ADTMD = 0b001; /* ADERR < ADLTH */ }
