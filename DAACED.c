...
void getDefaultSettings() {
    ...
    Settings.BuzzerParDuration = 200; // ms
    Settings.BuzzerStartDuration = 300; // ms
    Settings.BuzzerLevel = 1; // Most quiet sound
    ...
    Settings.BackLightLevel = 2; // Most dimmed visible
